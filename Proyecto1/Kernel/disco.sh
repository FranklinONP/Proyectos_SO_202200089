...
# Crear contenedor de tipo --hdd 1
container_name=$(generate_random_name)
docker run -d --name $container_name alpine-stress stress --hdd 1
echo "Contenedor $container_name creado con configuración: --hdd 1"
