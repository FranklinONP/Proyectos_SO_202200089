...
# Crear contenedor de tipo --cpu 1
container_name=$(generate_random_name)
docker run -d --name $container_name alpine-stress stress --cpu 1
echo "Contenedor $container_name creado con configuración: --cpu 1"
